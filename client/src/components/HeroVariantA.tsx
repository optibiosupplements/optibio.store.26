...
/*
 * Variant A hero section for OptiBio.
 *
 ...
 *   2. Import and render <HeroVariantA /> in your Home page instead of the old
 *      BuyBox component. For example:
 *
...
/** SVG icons used in the hero. Keeping these in the same file avoids external
 *  dependencies and makes the component self–contained. Each icon uses the
 *  currentColor stroke so that the surrounding CSS or inline style determines
 *  colour.
 */
        ...
        <div className="mx-auto max-w-7xl px-6 py-16 lg:px-10 lg:py-20">
          <div className="grid items-center gap-10 lg:grid-cols-[1.1fr,0.9fr]">
            ...
            <div className="space-y-7">
              ...
              {/* Headline */}
              <h1
                className="leading-[0.95] text-[#132B4C] font-extrabold tracking-[-0.04em]"
              ...
              {/* Subheadline */}
              <p className="max-w-xl text-[16px] leading-7 text-[#2D2D2D]" style={{ fontFamily: "Inter, ui-sans-serif" }}>
                Clinically studied ashwagandha for stress support, better sleep, and clearer focus — one
                capsule daily.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-6 pt-1 text-[#1E3A5F]">
                <div className="flex items-center gap-3">
                  ...
                  <div className="leading-tight">
                    <div className="text-sm font-semibold" style={{ fontFamily: "Inter, ui-sans-serif" }}>
                      Clinically studied extract
                    </div>
                    <div className="text-xs text-[#1E3A5F]/70" style={{ fontFamily: "Inter, ui-sans-serif" }}>
              ...
              <div className="max-w-xl rounded-[26px] border border-[#C9A961]/30 bg-white/80 shadow-[0_20px_60px_rgba(15,42,68,0.14)] backdrop-blur">
                <div className="p-6 sm:p-7">
                  ...
                  <div className="mt-4 rounded-[16px] border border-[#FDE68A] bg-[#FFFBEB] px-4 py-3">
                    <div className="flex items-center justify-center gap-2 text-[#7C2D12]" style={{ fontFamily: "Inter, ui-sans-serif" }}>
                  ...
                  {/* Trust micro row */}
                  <div className="mt-5 flex flex-wrap items-center justify-center gap-x-8 gap-y-2 border-t border-[#E2E8F0] pt-4 text-sm text-[#475569]" style={{ fontFamily: "Inter, ui-sans-serif" }}>
                    <div className="flex items-center gap-2">
              ...
              <div className="max-w-xl rounded-[22px] border border-[#BBF7D0] bg-[#F0FDF4] p-5 shadow-[0_12px_35px_rgba(15,42,68,0.10)]">
                <div className="flex flex-wrap items-center justify-between gap-4">
                  <div className="flex items-center gap-3">
                    {/* Avatars: if you have real avatars, replace the src values accordingly */}
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="text-sm font-bold text-[#132B4C]" style={{ fontFamily: "Inter, ui-sans-serif" }}>
                        {RATING}
                      </div>
                    </div>
                    <div className="mt-1 text-[15px] font-semibold text-[#132B4C]" style={{ fontFamily: "Inter, ui-sans-serif" }}>
                      {HAPPY_CUSTOMERS} happy customers
                    </div>
                    <div className="mt-1 flex items-center gap-2 text-[14px] font-semibold text-[#16A34A]" style={{ fontFamily: "Inter, ui-sans-serif" }}>
                      <span>✓</span>
                      {SOCIAL_TREND_LINE}
                    </div>
                  </div>
                ...
                <div className="rounded-[28px] border border-[#C9A961]/35 bg-white/85 p-6 shadow-[0_28px_70px_rgba(15,42,68,0.18)] backdrop-blur">
                  <div className="flex items-center justify-center">
                    <img
                      ...
                      alt="OptiBio Ashwagandha bottle"
