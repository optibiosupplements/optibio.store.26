      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <Card className="border-2 border-slate-200 dark:border-[#2D4A77] dark:border-[#2D4A77] shadow-xl">
          <CardContent className="p-8 space-y-8 prose prose-slate max-w-none">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Account Registration</h2>
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Product Information and Availability</h2>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Orders and Payment</h2>
              
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Order Acceptance</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Payment Processing</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3 mt-6">Pricing Errors</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Shipping and Delivery</h2>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Returns and Refunds</h2>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Subscription Services</h2>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Health Disclaimers</h2>
              
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">FDA Disclaimer</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
                These statements have not been evaluated by the Food and Drug Administration. This product is not intended to diagnose, treat, cure, or prevent any disease.
              </p>

              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Medical Advice</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3 mt-6">Individual Results</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Prohibited Uses</h2>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Dispute Resolution</h2>
              
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Governing Law</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
                These Terms shall be governed by and construed in accordance with the laws of the United States, without regard to its conflict of law provisions.
              </p>

              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Arbitration</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Severability</h2>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed">
            ...
            <section>
              ...
              <div className="p-6 rounded-xl bg-slate-50 border-2 border-slate-200 dark:border-[#2D4A77]">
                <p className="text-slate-900 dark:text-white font-semibold mb-2">Optibio</p>
                <p className="text-slate-700 dark:text-slate-200">Email: <a href="mailto:support@optibio.com" className="text-[#1E3A5F] hover:text-[#1E3A5F] font-semibold underline">support@optibio.com</a></p>
                <p className="text-slate-700 dark:text-slate-200">Legal: <a href="mailto:legal@optibio.com" className="text-[#1E3A5F] hover:text-[#1E3A5F] font-semibold underline">legal@optibio.com</a></p>
              </div>
            </section>

            <section className="border-t-2 border-slate-200 dark:border-[#2D4A77] dark:border-[#2D4A77] pt-6">
