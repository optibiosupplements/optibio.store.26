...
export default function Shipping() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-[#F7F4EF]/20 py-12 dark:bg-[#0B1120] dark:bg-[#0B1120]">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-slate-900 dark:text-white mb-2">Shipping & Returns</h1>
          <p className="text-slate-600 dark:text-slate-300">Last Updated: January 11, 2025</p>
        </div>

        <Card className="border-2 border-slate-200 dark:border-[#2D4A77] dark:border-[#2D4A77] shadow-xl mb-8">
          <CardContent className="p-8 space-y-8 prose prose-slate max-w-none">
            <section>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Shipping Policy</h2>
              </div>

              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Shipping Locations</h3>
              ...
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Processing Time</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Shipping Methods & Delivery Times</h3>
              <div className="space-y-4 mb-4">
                <div className="p-4 rounded-xl bg-slate-50 border-2 border-slate-200 dark:border-[#2D4A77]">
                  <h4 className="font-bold text-slate-900 dark:text-white mb-2">Standard Shipping (Free on orders $75+)</h4>
                  <p className="text-slate-700 dark:text-slate-200 text-sm mb-2">Delivery: 3-5 business days</p>
                  <p className="text-slate-700 dark:text-slate-200 text-sm">Cost: $5.99 (Free on orders $75 or more)</p>
                </div>

                <div className="p-4 rounded-xl bg-slate-50 border-2 border-slate-200 dark:border-[#2D4A77]">
                  <h4 className="font-bold text-slate-900 dark:text-white mb-2">Express Shipping</h4>
                  <p className="text-slate-700 dark:text-slate-200 text-sm mb-2">Delivery: 2-3 business days</p>
                  <p className="text-slate-700 dark:text-slate-200 text-sm">Cost: $12.99</p>
                </div>

                <div className="p-4 rounded-xl bg-slate-50 border-2 border-slate-200 dark:border-[#2D4A77]">
                  <h4 className="font-bold text-slate-900 dark:text-white mb-2">Overnight Shipping</h4>
                  <p className="text-slate-700 dark:text-slate-200 text-sm mb-2">Delivery: 1 business day</p>
                  <p className="text-slate-700 dark:text-slate-200 text-sm">Cost: $24.99</p>
                </div>
              </div>
              ...
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Order Tracking</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Shipping Carriers</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Address Accuracy</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Lost or Damaged Packages</h3>
          ...
          <CardContent className="p-8 space-y-8 prose prose-slate max-w-none">
            <section>
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Returns & Refunds</h2>
              </div>

              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">90-Day Money-Back Guarantee</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">How to Return a Product</h3>
              <div className="space-y-3 mb-4">
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="text-slate-900 dark:text-white font-semibold">Contact Us</p>
                    <p className="text-slate-700 dark:text-slate-200 text-sm">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="text-slate-900 dark:text-white font-semibold">Receive Return Authorization</p>
                    <p className="text-slate-700 dark:text-slate-200 text-sm">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="text-slate-900 dark:text-white font-semibold">Ship Your Return</p>
                    <p className="text-slate-700 dark:text-slate-200 text-sm">
                ...
                <div className="flex gap-3">
                  ...
                  <div>
                    <p className="text-slate-900 dark:text-white font-semibold">Get Your Refund</p>
                    <p className="text-slate-700 dark:text-slate-200 text-sm">
              ...
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Return Conditions</h3>
              <ul className="list-disc list-inside space-y-2 text-slate-700 dark:text-slate-200 dark:text-slate-200 mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Refund Processing</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Exchanges</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Defective or Damaged Products</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Subscription Returns</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed">
        ...
        <Card className="border-2 border-slate-200 dark:border-[#2D4A77] dark:border-[#2D4A77] shadow-xl">
          <CardContent className="p-8 space-y-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white">Additional Information</h2>
            </div>

            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Order Cancellation</h3>
              ...
              <div>
                <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Incorrect Orders</h3>
                <p className="text-slate-700 dark:text-slate-200 text-sm leading-relaxed">
              ...
              <div>
                <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2">Questions?</h3>
                ...
                <div className="p-4 rounded-xl bg-slate-50 border-2 border-slate-200 dark:border-[#2D4A77]">
                  <p className="text-slate-900 dark:text-white font-semibold mb-2">Contact Optibio Support</p>
                  <p className="text-slate-700 dark:text-slate-200 text-sm">Email: <a href="mailto:support@optibio.com" className="text-[#1E3A5F] hover:text-[#1E3A5F] font-semibold underline">support@optibio.com</a></p>
                  <p className="text-slate-700 dark:text-slate-200 text-sm">Response Time: Within 24 hours (business days)</p>
                </div>
              </div>
            </div>
          </CardContent>
