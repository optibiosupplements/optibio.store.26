        ...
        <Card className="border-2 border-slate-200 dark:border-[#2D4A77] dark:border-[#2D4A77] shadow-xl">
          <CardContent className="p-8 space-y-8 prose prose-slate max-w-none">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Personal Information</h3>
              ...
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3 mt-6">Automatically Collected Information</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Information Sharing and Disclosure</h2>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
                We do not sell, trade, or rent your personal information to third parties. We may share your information with:
              </p>
              
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Service Providers</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-slate-900 dark:text-white mb-3">Legal Requirements</h3>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Your Privacy Rights</h2>
              <p className="text-slate-700 dark:text-slate-200 leading-relaxed mb-4">
            ...
            <section>
              ...
              <div className="p-6 rounded-xl bg-slate-50 border-2 border-slate-200 dark:border-[#2D4A77]">
                ...
                <p className="text-slate-700 dark:text-slate-200">Email: <a href="mailto:privacy@optibio.com" className="text-[#1E3A5F] hover:text-[#1E3A5F] font-semibold underline">privacy@optibio.com</a></p>
                <p className="text-slate-700 dark:text-slate-200">Support: <a href="mailto:support@optibio.com" className="text-[#1E3A5F] hover:text-[#1E3A5F] font-semibold underline">support@optibio.com</a></p>
              </div>
            </section>
