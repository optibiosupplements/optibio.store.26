...
export default function Analytics() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[var(--optibio-abyssal)]">
      {/* Header */}
      <div className="bg-white dark:bg-[var(--optibio-navy)] border-b">
              ...
              <CardContent>
                <div className="space-y-4">
                  {(cartMetrics.data?.recoveryRate || 0) < 15 && (
                    <div className="p-4 bg-white dark:bg-[var(--optibio-navy)] dark:bg-[var(--optibio-navy)] rounded-lg border border-blue-200">
                  ...
                  {(cartMetrics.data?.recoveryRate || 0) >= 15 && 
                   (emailMetrics.data?.reorderRate || 0) >= 25 && 
                   (emailMetrics.data?.subscriptionRate || 0) >= 10 && (
                    <div className="p-4 bg-white dark:bg-[var(--optibio-navy)] dark:bg-[var(--optibio-navy)] rounded-lg border border-green-200">
